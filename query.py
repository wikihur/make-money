...
class MyWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self.setWindowTitle("PyStock Query")
        ...
        self.text_edit.setGeometry(10,60,460,630)
    ...
    def receive_trdata(self, screen_no, rqname, trcode, recordname, prev_next, data_len, err_code, msg1, msg2):
        ...
        if rqname == "opt10003_req":
            strong = self.kiwoom.dynamicCall("CommGetData(QString, QString, QString, int, QString)", trcode, "", rqname, 0, "체결강도")
            price = self.kiwoom.dynamicCall("CommGetData(QString, QString, QString, int, QString)", trcode, "", rqname, 0, "현재가")
            time = self.kiwoom.dynamicCall("CommGetData(QString, QString, QString, int, QString)", trcode, "", rqname, 0, "시간")
            self.text_edit.append("시간: " + time.strip() + ", 체결강도: " + strong.strip() + ", 현재가: " + price.strip())
